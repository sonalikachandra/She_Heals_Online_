...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $Password = $_POST['pass'];
        echo $Password;
        $sql = "select * from signup_details where Username = '$username'or Email = '$username'";  
        ...
        if($row){  
            ...
            if(Password_verify($Password, $row["Password"])){
                ...
                $sql = "select Username from signup_details where Username = '$username'or Email = '$username'";     
